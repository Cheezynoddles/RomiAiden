...
public class TurnLeftDegrees extends CommandBase {
  ...
  /**
   * Creates a new TurnLeftDegrees. This command will turn your robots left wheel for a desired rotation (in
   ...
   */
  public TurnLeftDegrees(double speed, double degrees, Drivetrain drive) {
    m_degrees = degrees;
    m_speed = speed;
    m_drive = drive;
