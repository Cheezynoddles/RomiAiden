...
public class Drivetrain extends SubsystemBase {
  ...
  public void arcadeDrive(double xaxisSpeed, double zaxisRotate) {
    // double gyroAdjust = getGyroAdjust();
  ...
  //tankDrive will let you control the speed of each wheel individually
  ...
  private double getGyroAdjust() {
    double headingDifference = m_gyro.getAngleZ() - this.targetHeading;
